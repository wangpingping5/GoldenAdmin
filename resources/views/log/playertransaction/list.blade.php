@extends('layouts.app',[
        'parentSection' => 'loglist3',
        'elementName' => 'PlayerTransaction'
    ])
@section('content')
				...
				<div class="collapse show">				
					<div class="card-body">
						...
						<div class=" mt-4 mb-sm-2">
							<div class="row">
								<div class="col">
									<div class="float-start"><h5>{{__('PlayerTransaction')}}</h5></div>								                                       
								</div>
							</div>
						</div>
							...
							<table class="table align-items-center text-center table-flush table-bordered">
								<thead class="thead-light">
									<tr>
										...
										<th scope="col" class="text-center">{{__('PreviousBalance')}}</th>
										<th scope="col" class="text-center">{{__('NewBalance')}}</th>
								...
								<tbody>
									@if (count($statistics))
										@foreach ($statistics as $stat)
											@include('log.playertransaction.partials.row')
										@endforeach
									@else
