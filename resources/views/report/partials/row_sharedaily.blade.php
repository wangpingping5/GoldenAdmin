    ...
    <table>
        <tbody>
            <tr>
                ...
                <td class="text-end w-90">{{ number_format($adjustment->bet, 2)}}</td>
            </tr>
            <tr>
                <td class="text-start"><span  class="btn btn-warning px-2 py-1 mb-1 rounded-0">파트너배팅금</span></td>
                <td class="text-end w-90">{{ number_format($adjustment->betlimit, 2)}}</td>
            </tr>
            <tr>
                <td class="text-start"><span  class="btn btn-success px-2 py-1 mb-1 rounded-0">받치기배팅금</span></td>
                <td class="text-end w-90">{{ number_format($adjustment->bet - $adjustment->betlimit, 2)}}</td>
            </tr>
        </tbody>
    </table>
</td>
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td class="text-end w-90">{{ number_format($adjustment->win, 2)}}</td>
            </tr>
            <tr>
                <td class="text-start"><span  class="btn btn-warning px-2 py-1 mb-1 rounded-0">파트너당첨금</span></td>
                <td class="text-end w-90">{{ number_format($adjustment->winlimit, 2)}}</td>
            </tr>
            <tr>
                <td class="text-start"><span  class="btn btn-success px-2 py-1 mb-1 rounded-0">받치기당첨금</span></td>
                <td class="text-end w-90">{{ number_format($adjustment->win - $adjustment->winlimit, 2)}}</td>
            </tr>
        </tbody>
    </table>
</td>
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td class="text-end w-90">{{ number_format($adjustment->bet - $adjustment->win, 2)}}</td>
            </tr>
            <tr>
                <td class="text-start"><span  class="btn btn-warning px-2 py-1 mb-1 rounded-0">파트너벳원</span></td>
                <td class="text-end w-90">{{ number_format($adjustment->betlimit - $adjustment->winlimit, 2)}}</td>
            </tr>
            <tr>
                <td class="text-start"><span  class="btn btn-success px-2 py-1 mb-1 rounded-0">받치기벳원</span></td>
                <td class="text-end w-90">{{ number_format($adjustment->bet - $adjustment->win - $adjustment->betlimit + $adjustment->winlimit, 2)}}</td>
            </tr>
        </tbody>
    </table>
</td>
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td class="text-end w-90">{{ number_format($adjustment->deal_limit + $adjustment->deal_share, 2)}}</td>
            </tr>
            <tr>
                <td class="text-start"><span  class="btn btn-warning px-2 py-1 mb-1 rounded-0">파트너롤링금</span></td>
                <td class="text-end w-90">{{ number_format($adjustment->deal_limit, 2)}}</td>
            </tr>
            <tr>
                <td class="text-start"><span  class="btn btn-success px-2 py-1 mb-1 rounded-0">받치기롤링금</span></td>
                <td class="text-end w-90">{{ number_format($adjustment->deal_share, 2)}}</td>
            </tr>
        </tbody>
    </table>
</td>
<td>{{ number_format($adjustment->deal_out, 2) }}</td>
