@extends('layouts.app',[
        'parentSection' => 'exchange',
        'elementName' => 'Exchange Request'
    ])
@section('content')
            ...
            <div class="card p-4">
                <div class="row mt-4">
                    <div class="col-md-12 col-lg-12">
                        <div class="row">
                            <p class="text-dark h5">{{__('Exchange Request')}}</p>
                                ...
                                <div class="table-responsive col-12">
                                    <table class="table table-bordered align-items-center text-start table-flush  mb-0" id="datalist">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{__('agent.WithdrawPassword')}}</td>
                                                <td>
                                                    <div>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <div class="text-center">
                                                        <button type="button" class="btn btn-primary mb-0" id="doSubmit" onclick="withdraw_balance();">{{__('agent.WithdrawRequest')}}</button>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                ...
                <div class="row mt-4">
                    <p class="text-dark h6">{{__('agent.RecentlryWithdrawRequestHistory')}}</p>
                </div>
...
<script>
    ...
    function withdraw_balance() {
        ...
        $.ajax({
            ...
            url: "{{argon_route('common.withdraw')}}",
                ...
                if (data.error) {
                    ...
                    else if (data.code == '010')
                    {
                        show_alarm(data.msg, function() {
                            location.href = "{{argon_route('common.profile')}}";
                        });
                        return;
                    }
                    show_alarm(data.msg);
