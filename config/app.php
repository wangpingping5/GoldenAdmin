...
return [
    ...
    */
    ...
    'wildwest_api' => env('WILDWEST_API', ''),
    'wildwest_agent' => env('WILDWEST_AGENT', ''),
    'wildwest_secretkey' => env('WILDWEST_PASSWORD', ''),
    'wildwest_saltkey' => env('WILDWEST_SALTKEY', ''),

    'nowpay_api' => env('NOWPAY_API', ''),
    'nowpay_secretkey' => env('NOWPAY_KEY', ''),
    'nowpay_ipn_callback' => env('NOWPAY_IPN_CALLBACK', ''),
    'nowpay_ipn_secretkey' => env('NOWPAY_IPN_SECRETKEY', ''),

    'oroplay_api' => env('OROPLAY_API', ''),
    'oroplay_agent' => env('OROPLAY_AGENT', ''),
    'oroplay_secretkey' => env('OROPLAY_PASSWORD', ''),
    /*
    |--------------------------------------------------------------------------
